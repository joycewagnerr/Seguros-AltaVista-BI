...
INSERT INTO "SEGURO_G29611513".registro_contrato (nro_contrato, cod_producto, cod_cliente, fecha_inicio, fecha_fin, monto, estado_contrato) VALUES
    (1, 1, 1, '2023-01-14', '2024-01-14', 140.0, 'activo'),
    (2, 5, 2, '2023-02-25', '2024-02-25', 500.0, 'vencido'),
    (3, 6, 3, '2023-02-04', '2024-02-04', 89.0, 'suspendido'),
    (4, 7, 4, '2023-03-07', '2024-03-07', 230.0, 'activo'),
    (5, 4, 5, '2023-04-09', '2024-04-09', 160.0, 'vencido'),
    (6, 4, 6, '2023-04-30', '2024-04-30', 170.0, 'suspendido'),
    (7, 2, 7, '2023-05-17', '2024-05-17', 1789.0, 'activo'),
    (8, 5, 8, '2023-06-05', '2024-06-05', 256.0, 'vencido'),
    (9, 3, 9, '2023-07-17', '2024-07-17', 684.0, 'suspendido'),
    (10, 6, 10, '2023-08-16', '2024-08-16', 462.0, 'activo'),
    (11, 4, 11, '2023-09-03', '2024-09-03', 578.0, 'vencido'),
    (12, 2, 12, '2023-10-14', '2024-10-14', 103.0, 'suspendido'),
    (13, 7, 13, '2023-11-20', '2024-11-20', 445.0, 'activo'),
    (14, 6, 14, '2023-11-30', '2024-11-30', 8569.0, 'vencido'),
    (15, 2, 15, '2023-12-05', '2024-12-05', 1542.0, 'suspendido'),
	  (1, 2, 36, '2023-01-14', '2024-01-14', 140.0, 'activo');
