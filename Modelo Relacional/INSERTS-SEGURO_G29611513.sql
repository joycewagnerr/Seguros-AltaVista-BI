...
INSERT INTO "SEGURO_G29611513".registro_contrato (nro_contrato, cod_producto, cod_cliente, cod_sucursal, fecha_inicio, fecha_fin, monto, estado_contrato) VALUES
    ...
    (6, 6, 11, 3, '2023-05-30', '2024-05-30', 1425, 'activo'),
    (2, 6, 9, 2, '2022-03-25', '2023-03-25', 802, 'vencido'),
    (14, 6, 30, 2, '2022-10-09', '2023-10-09', 25, 'vencido'),
    (7, 1, 21, 2, '2023-05-12', '2024-05-12', 405, 'vencido'),
    (6, 7, 28, 2, '2023-08-09', '2024-08-09', 1880, 'vencido'),
    (10, 6, 26, 1, '2022-07-01', '2023-07-01', 1870, 'activo'),
    (7, 2, 27, 3, '2023-08-19', '2024-08-19', 1880, 'activo'),
    (12, 5, 23, 2, '2023-10-03', '2024-10-03', 228, 'activo'),
    (6, 7, 21, 2, '2023-04-20', '2024-04-20', 383, 'suspendido'),
    (9, 7, 21, 2, '2022-12-12', '2023-12-12', 14, 'activo'),
    (13, 1, 13, 3, '2022-03-09', '2023-03-09', 566, 'suspendido'),
    (8, 6, 1, 1, '2022-12-27', '2023-12-27', 215, 'suspendido'),
    (12, 6, 14, 4, '2022-01-11', '2023-01-11', 852, 'vencido'),
    (13, 1, 2, 1, '2022-04-22', '2023-04-22', 1946, 'activo'),
    (2, 6, 29, 4, '2022-03-24', '2023-03-24', 39, 'activo'),
    (9, 4, 11, 3, '2023-08-08', '2024-08-08', 382, 'vencido'),
    (12, 7, 27, 3, '2022-08-01', '2023-08-01', 96, 'vencido'),
    (12, 1, 33, 4, '2023-02-12', '2024-02-12', 1191, 'activo'),
    (14, 5, 18, 1, '2023-04-06', '2024-04-06', 1658, 'activo'),
    (12, 5, 10, 3, '2023-10-22', '2024-10-22', 743, 'suspendido'),
    (6, 7, 19, 1, '2022-06-29', '2023-06-29', 1236, 'suspendido'),
    (8, 3, 1, 1, '2023-01-26', '2024-01-26', 1340, 'activo'),
    (11, 4, 3, 1, '2022-02-01', '2023-02-01', 674, 'suspendido'),
    (5, 7, 15, 4, '2022-05-26', '2023-05-26', 163, 'activo'),
    (5, 3, 9, 2, '2022-10-26', '2023-10-26', 627, 'suspendido'),
    (6, 4, 27, 3, '2022-03-16', '2023-03-16', 693, 'vencido'),
    (10, 7, 8, 2, '2022-10-29', '2023-10-29', 272, 'suspendido'),
    (6, 6, 35, 3, '2022-12-23', '2023-12-23', 1292, 'activo'),
    (7, 5, 10, 3, '2023-10-27', '2024-10-27', 667, 'suspendido'),
    (12, 4, 18, 1, '2023-05-23', '2024-05-23', 1465, 'activo'),
    (10, 1, 30, 2, '2022-07-21', '2023-07-21', 459, 'activo'),
    (14, 2, 33, 4, '2022-06-13', '2023-06-13', 1784, 'suspendido'),
    (15, 1, 6, 2, '2022-03-17', '2023-03-17', 821, 'activo'),
    (12, 1, 19, 1, '2022-09-29', '2023-09-29', 379, 'suspendido'),
    (1, 6, 30, 2, '2023-08-19', '2024-08-19', 1825, 'activo'),
    (1, 7, 31, 4, '2022-04-19', '2023-04-19', 1167, 'vencido'),
    (2, 6, 6, 2, '2022-08-26', '2023-08-26', 60, 'activo'),
    (2, 2, 24, 4, '2022-05-24', '2023-05-24', 1467, 'vencido'),
    (14, 5, 24, 4, '2022-11-07', '2023-11-07', 336, 'suspendido'),
    (4, 7, 20, 4, '2022-03-01', '2023-03-01', 1192, 'activo'),
    (14, 3, 21, 2, '2023-12-30', '2024-12-30', 1529, 'vencido'),
    (4, 6, 25, 3, '2022-08-18', '2023-08-18', 151, 'vencido'),
    (4, 4, 2, 1, '2022-08-03', '2023-08-03', 1707, 'activo'),
    (6, 3, 5, 2, '2023-05-02', '2024-05-02', 1897, 'suspendido'),
    (2, 4, 19, 1, '2023-01-28', '2024-01-28', 710, 'suspendido'),
    (7, 4, 30, 2, '2022-10-19', '2023-10-19', 1735, 'activo'),
    (10, 2, 33, 4, '2022-02-16', '2023-02-16', 689, 'activo'),
    (10, 4, 34, 3, '2022-09-23', '2023-09-23', 1378, 'activo'),
    (12, 2, 8, 2, '2022-01-18', '2023-01-18', 1504, 'vencido'),
    (4, 6, 14, 4, '2023-05-24', '2024-05-24', 929, 'activo'),
    (6, 3, 20, 4, '2023-04-01', '2024-04-01', 113, 'activo'),
    (11, 4, 29, 4, '2023-10-03', '2024-10-03', 357, 'vencido'),
    (6, 6, 15, 4, '2023-10-16', '2024-10-16', 1041, 'suspendido'),
    (7, 7, 11, 3, '2022-07-24', '2023-07-24', 1451, 'activo'),
    (4, 3, 20, 4, '2022-02-09', '2023-02-09', 1191, 'activo'),
    (9, 3, 4, 1, '2023-06-02', '2024-06-02', 989, 'suspendido'),
    (14, 7, 26, 1, '2022-05-22', '2023-05-22', 1699, 'activo'),
    (5, 5, 29, 4, '2022-03-10', '2023-03-10', 1444, 'activo'),
    (3, 4, 8, 2, '2023-12-29', '2024-12-29', 173, 'activo'),
    (6, 1, 9, 2, '2022-12-22', '2023-12-22', 1846, 'activo'),
    (3, 2, 19, 1, '2022-12-08', '2023-12-08', 230, 'activo'),
    (2, 6, 36, 4, '2023-08-17', '2024-08-17', 1529, 'activo'),
    (14, 7, 29, 4, '2023-06-28', '2024-06-28', 154, 'activo'),
    (1, 1, 28, 2, '2022-03-08', '2023-03-08', 1730, 'suspendido'),
    (12, 2, 9, 2, '2022-05-31', '2023-05-31', 273, 'activo'),
    (3, 1, 28, 2, '2023-04-05', '2024-04-05', 495, 'vencido'),
    (11, 1, 26, 1, '2022-03-20', '2023-03-20', 535, 'activo'),
    (2, 6, 15, 4, '2023-05-15', '2024-05-15', 1296, 'vencido'),
    (9, 1, 30, 2, '2023-11-21', '2024-11-21', 1133, 'vencido'),
    (2, 4, 1, 1, '2023-07-28', '2024-07-28', 1669, 'activo'),
    (11, 3, 21, 2, '2023-04-22', '2024-04-22', 752, 'activo'),
    (14, 7, 22, 3, '2023-02-12', '2024-02-12', 1107, 'vencido'),
    (14, 5, 17, 1, '2023-06-02', '2024-06-02', 886, 'suspendido'),
    (8, 5, 16, 2, '2023-07-09', '2024-07-09', 1770, 'activo'),
    (15, 6, 30, 2, '2023-03-20', '2024-03-20', 795, 'vencido'),
    (4, 2, 28, 2, '2023-01-01', '2024-01-01', 1516, 'suspendido'),
    (9, 3, 11, 3, '2022-12-07', '2023-12-07', 69, 'activo'),
    (1, 2, 32, 2, '2022-07-23', '2023-07-23', 702, 'vencido'),
    (8, 6, 5, 2, '2023-01-16', '2024-01-16', 1237, 'activo'),
    (8, 2, 22, 3, '2023-11-03', '2024-11-03', 1230, 'vencido'),
    (4, 5, 24, 4, '2022-04-23', '2023-04-23', 1215, 'activo'),
    (14, 1, 26, 1, '2022-06-03', '2023-06-03', 1620, 'activo'),
    (12, 3, 1, 1, '2023-07-31', '2024-07-31', 826, 'activo'),
    (5, 5, 12, 3, '2022-01-09', '2023-01-09', 1001, 'activo'),
    (15, 6, 23, 2, '2022-07-26', '2023-07-26', 1983, 'suspendido'),
    (9, 6, 6, 2, '2022-09-28', '2023-09-28', 1286, 'activo'),
    (8, 6, 7, 3, '2023-08-19', '2024-08-19', 1619, 'activo'),
    (13, 4, 4, 1, '2022-09-16', '2023-09-16', 1557, 'activo'),
    (5, 1, 32, 2, '2022-04-02', '2023-04-02', 550, 'activo'),
    (8, 7, 17, 1, '2022-06-19', '2023-06-19', 1655, 'suspendido'),
    (5, 2, 8, 2, '2022-03-03', '2023-03-03', 1184, 'suspendido'),
    (8, 4, 30, 2, '2023-03-06', '2024-03-06', 151, 'activo'),
    (2, 2, 3, 1, '2023-02-21', '2024-02-21', 796, 'activo'),
    (12, 5, 5, 2, '2022-10-22', '2023-10-22', 1754, 'suspendido'),
    (14, 3, 31, 4, '2023-09-22', '2024-09-22', 1103, 'vencido'),
    (13, 5, 6, 2, '2023-06-05', '2024-06-05', 1336, 'vencido'),
    (3, 4, 9, 2, '2023-04-07', '2024-04-07', 226, 'activo'),
    (3, 2, 31, 4, '2022-10-31', '2023-10-31', 147, 'activo');
...
INSERT INTO "SEGURO_G29611513".metas (nro_contrato, cod_producto, fecha_inicio_meta, fecha_fin_meta, monto_meta_ingreso, meta_renovacion, meta_asegurado) VALUES
    (1, 1, '2023-01-01', '2024-01-01', 30000.00, 50, 100),
    (2, 5, '2023-01-01', '2024-01-01', 10000.00, 20, 80),
    (9, 3, '2023-01-01', '2024-01-01', 14000.00, 30, 70),
    (11, 4, '2023-01-01', '2024-01-01', 20000.00, 80, 100),
    (5, 6, '2023-01-01', '2024-01-01', 40000.00, 50, 70),
    (4, 7, '2023-01-01', '2024-01-01', 20000.00, 50, 80),
    (7, 2, '2023-01-01', '2024-01-01', 30000.00, 50, 80);